const messageOffer = {
  ...
  dont_want_to_talk: {
    text: `⛔️ Как отказаться от вакансии. `,
    discription: `*Пример ответного письма*`,
  ...
  dont_you_cry: {
    ...
    discription: `*Пример ответного письма на отказ*`,
  ...
  you_love_her: {
    text: '🥰 В случае если с hr случилась "взаимная любовь" ',
    discription: `*Пример письма*`,
  ...
  answer_yes: {
    ...
    Готов(а) приступить к работе с _число.месяц_ и с нетерпением жду своего первого дня в Вашей компании.\nЕсли у Вас есть ко мне дополнительные вопросы, готов(а) ответить в удобное Вам время.
    \nС уважением, _Ваше имя_.`,
  },
  ...
  no_explain: {
    discription: `*Пример ответного письма без объяснения причины*`,
    helper: `Здравствуйте, _Имя HR-менеджера_.\nСпасибо за предложение присоединиться к команде _название компании_. Я ценю время, которое Вы потратили на то, чтобы провести собеседование и ответить на все мои вопросы.\nМне нелегко далось это решение, но я вынужден(а) отказаться от Вашего предложения.\nЖелаю Вам успехов в поиске подходящего кандидата на эту должность. Всего наилучшего Вам и _название компании_!\nС уважением, _Ваше имя_.`,
  },
  explain: {
    discription: `*Пример ответного письма c объяснением причины*`,
    helper: `Здравствуйте, _Имя HR-менеджера_.\nСпасибо за предложение стать частью _название компании_ в роли _название позиции_. Я ценю предоставленную возможность и Ваш интерес к моей кандидатуре.\nК сожалению, я выбрал(а) позицию в другой компании. На данном этапе она лучше всего соответствует моим карьерным ожиданиям и целям.\nЕще раз спасибо за Ваше время и приятный опыт собеседования!\nС уважением, _Ваше имя_`,
  }
}
